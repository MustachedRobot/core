...
{
	/**
	 * Returns an array of associative arrays correctly formated according to the $return parameter 
	 *
	...
	protected function filter_array($items, $return) {
		...
		if(is_array($items[0]))
		{
			...
			{
					$result[] = \Arr::filter_keys($item, $return);	
			}			
		}
		else
		{
			$result[] = \Arr::filter_keys($items, $return);	
		}
